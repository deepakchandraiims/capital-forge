...
function Top(){const router=useRouter();return <header className={styles.top}><div className={styles.brand}><div className={styles.mark}>CF</div><div><b>Capital Forge Interview Room</b><small>Canonical finance interview simulation</small></div></div><div className={styles.topActions}><button onClick={()=>router.push("/interview")}>Exit to Interview Room</button></div></header>}
