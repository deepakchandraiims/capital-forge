...
export default function InterviewResults(){
  ...
  if(!session)return <div className={styles.shell}><main className={styles.main}><section className={styles.device}><h1>Result not found</h1><p>This report is not available in this browser.</p><button className={styles.primary} onClick={()=>router.push("/interview")}>Back to Interview Room</button></section></main></div>;
