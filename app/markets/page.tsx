  ...
  return <div className="markets-app">
    ...
    <main className="markets-shell">
      ...
      <section className="markets-bottom-grid">
        ...
        <div className="markets-card learning"><p>LEARNING MODE</p><h3>Turn this market move into a finance drill</h3><small>Ask what changed in valuation, discount rates, risk appetite, earnings expectations or macro conditions.</small><button onClick={()=>window.location.assign(`/?open=Advanced&prompt=${encodeURIComponent(`Analyze ${displayName} (${symbol}) over ${range}. Explain the price move, likely macro/company drivers, valuation implications, risks and what I should learn from it.`)}`)}>✦ Analyze with AI</button></div>
      </section>
    </main>
  </div>;
}
